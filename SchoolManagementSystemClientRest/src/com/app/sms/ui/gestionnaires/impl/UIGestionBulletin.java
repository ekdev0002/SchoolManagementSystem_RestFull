...
public class UIGestionBulletin extends AbstractUIOperation implements IUGestionBulletin{
	...
	public UIGestionBulletin() {
		...
		JLabel lblSemestretrimestre = new JLabel("Semestre");
		rechercherPanel.add(lblSemestretrimestre);
		
		JLabel lblNewLabel = new JLabel("N°:");
		rechercherPanel.add(lblNewLabel);
		
		spinner = new JSpinner();
		spinner.setValue(1);
		rechercherPanel.add(spinner);
	...
	{
		return "Semestre "+spinner.getValue().toString();
	}
}